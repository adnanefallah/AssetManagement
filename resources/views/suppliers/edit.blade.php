    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-500 mt-1">
                {{ __('suppliers.edit_supplier_description') }}
            </p>
            ...
            <form action="{{ route('suppliers.update', $supplier) }}" method="POST">
                ...
                <div class="mt-6">
                    ...
                    <textarea
                        name="address"
                        rows="4"
                        class="w-full rounded-lg border-gray-300 focus:border-black focus:ring-black">{{ old('address', $supplier->address) }}</textarea>
